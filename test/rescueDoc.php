<?php
    ...
    /**
     * en-US: Calling the desired layout and passing the variables expecteds and disred. At this case rescuing informations about some document
     * pt-BR: Invoca o layout desejado e passa as variáveis esperadas e desejadas. Nesse caso recuperando informações de algum documento
     */
    $l = new rescueDoc();
    $l->document_id = '';
