<?php
    /**
     * An especial thanks for João our new Contributor that put this beautiful sandbox skill to our project
     */
    ...
    $sandboxMode = true; //en-US: change the sandbox mode to create test documents, if wanted | pt-BR: mude o modo sandbox para criar documentos teste, se desejado
