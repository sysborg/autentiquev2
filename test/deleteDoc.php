<?php
    ...
    use sysborg\autentiquev2\deleteDoc;
    ...
    /**
     * en-US: Calling the desired layout and passing the variables expecteds and disred. At this case the deleting documents.
     * pt-BR: Invoca o layout desejado e passa as variáveis esperadas e desejadas. Nesse caso deletando documentos.
     */
    $l = new deleteDoc();
    $l->document_id = '';
