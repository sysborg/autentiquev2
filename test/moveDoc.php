<?php
    ...
    /**
     * en-US: Calling the desired layout and passing the variables expecteds and disred. At this case moving a document to some directory
     * pt-BR: Invoca o layout desejado e passa as variáveis esperadas e desejadas. Nesse caso movendo um documento para algum diretório
     */
    $l = new moveDoc();
    $l->folder_id = '';
    $l->document_id = '';
